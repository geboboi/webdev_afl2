                        ...
                        <form action="{{ route('admin.event.update', $events->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{$events->event_name}}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="desc" name="desc" value="{{$events->description}}" rows="5" required></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="example-fileinput" class="form-label mb-3">Start Date</label>
                                    <input type="date" id="start_date" name="start_date" value="{{$events->start_date}}" class="form-control" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="example-fileinput" class="form-label mb-3">End Date</label>
                                    <input type="date" id="end_date" name="end_date" value="{{$events->end_date}}" class="form-control" required>
                                </div>
                            </div>
