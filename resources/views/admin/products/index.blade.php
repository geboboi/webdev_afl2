        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-sm-4">
                        <a href="{{route('admin.product.create')}}"><button type="button" class="btn btn-primary waves-effect waves-light mb-3"><i class="fas fa-plus px-1"></i> Add Product</button></a>
                    </div>
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href ="{{route('admin.product.edit', $product->id)}}"><button type="button" class="btn btn-success waves-effect waves-light" name="edit" id="edit"><i class="fas fa-edit"></i></button></a>
